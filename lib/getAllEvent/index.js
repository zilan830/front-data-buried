...
var getAllEvent = function (infoObj) {
    ...
    window.onbeforeunload = function () {
        ...
        index_1.default.postData(__assign({}, eventParams)).then(function () {
            //console.log("res....", res)
        }).catch(function (e) {
            //console.log("e", e)
        });
    ...
    var sendData = function (_a) {
        var eventParams = _a.eventParams, preTitle = _a.preTitle, nowTitle = _a.nowTitle;
        index_1.default.postData(__assign({}, eventParams)).then(function () {
            //console.log("res....", res)
    ...
    var callback = function (mutationsList) {
        ...
        timer = setTimeout(function () {
            ...
            sendData({ eventParams: eventParams, preTitle: preTitle, nowTitle: nowTitle });
        }, 0);
    };
